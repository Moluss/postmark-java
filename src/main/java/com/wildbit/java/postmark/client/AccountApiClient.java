...
public class AccountApiClient extends BaseApiClient {
    ...
    public AccountApiClient(String baseUrl, HashMap<String,Object> headers) {
        super(baseUrl,headers);
    }

    public AccountApiClient(String baseUrl, HashMap<String,Object> headers, boolean secureConnection) {
